...
export default function DateInput(props) {
  ...
  return (
    <>
      <Button borderRadius='full' onClick={onOpen} width='100%' bg='#800000' color='white' fontFamily='Courier New' fontSize='xl'>
          Забронировать
      </Button>
      ...
      <Modal isOpen={isOpen} onClose={onClose}>
        <ModalOverlay />
        <ModalContent>
          <ModalHeader ml='55' fontSize='l' fontFamily='Courier New'>Выберете даты въезда и выезда</ModalHeader>
          <ModalCloseButton />
          <ModalBody>
          <Center>
            <Box borderWidth='1px' borderColor='#800000' width='50%'>
            ...
            <Button mt='3' bg='#800000' color='white' fontFamily='Courier New' width='100%' onClick={put}>
