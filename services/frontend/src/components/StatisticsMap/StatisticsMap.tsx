...
class StatisticsMap extends React.Component<StatisticsBoxProps, State> {
    ...
    render() {
        return (
            <Box fontFamily='Courier New' width='100%'>

                
                <Box borderRadius='' borderWidth='2px' borderColor='#800000'>
                <Center>
                ...
                <Box mt='8' borderRadius='' borderWidth='2px' borderColor='#800000'>
                <Center>
                <Text my='4' fontSize='2xl'>
                ...
                <Center>
                <Text my='4' fontSize='2xl'>
                ________________ЗАПРОСЫ________________
                </Text>
                </Center>
