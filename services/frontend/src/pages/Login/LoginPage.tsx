...
class LoginPage extends React.Component<LoginProps> {
    ...
    render() {
        return <Box fontFamily='Courier New' bg='#D2691E' borderRadius='' width='50%'>
            ...
            <Box p='3'>
            <Center>
                <Input bg='#8B4513' color='white' width='95%' variant='' name="login" type="login" placeholder="Логин"
                onInput={event => this.setLogin(event.currentTarget.value)}/>
            </Center>
            </Box>
            <Box p='3'>
            <Center>
                <Input bg='#8B4513' color='white' width='95%' variant='' name="password" type="password" placeholder="Пароль"
            ...
            <Box p='3'>
                <Box>
                    <Center>
                    <Button width='95%' bg='maroon' color='white' onClick={ (event) => this.submit(event) }> Войти </Button>
                    </Center>
                </Box>

                <Box>
                    <Text mt='4' ml='4'>Еще нет аккаунта?    
                        <Link color='#800000' href="/register"> Зарегистрироваться </Link>
                    </Text>
                </Box>
                <Box>
                    <Link ml='4' color='#800000' href="/">Назад</Link>
                </Box>
            </Box>
        </Box>
    }
